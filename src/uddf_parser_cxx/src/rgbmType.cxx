...
namespace streit
{
  ...
  const rgbmType::tissue_sequence& rgbmType::
  tissue () const
  {
    return this->tissue_;
  }

  rgbmType::tissue_sequence& rgbmType::
  tissue ()
  {
    return this->tissue_;
  }
...
namespace streit
{
  ...
  rgbmType::
  rgbmType (const ::xercesc::DOMElement& e,
            ::xml_schema::flags f,
            ::xml_schema::container* c)
  ...
  {
    return new class rgbmType (*this, f, c);
  }

  rgbmType& rgbmType::
  operator= (const rgbmType& x)
  {
    if (this != &x)
    {
...
{
  ::std::ostream&
  operator<< (::std::ostream& o, const rgbmType& i)
  {
    o << static_cast< const ::streit::ID_TYPE& > (i);

    for (rgbmType::tissue_const_iterator
