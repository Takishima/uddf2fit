...
namespace streit
{
  ...
  _xsd_kind_convert () const
  {
    ...
    const value* i (::std::lower_bound (
                      _xsd_kind_indexes_,
                      _xsd_kind_indexes_ + 2,
                      *this,
                      c));

    if (i == _xsd_kind_indexes_ + 2 || _xsd_kind_literals_[*i] != *this)
    {
...
{
  ::std::ostream&
  operator<< (::std::ostream& o, kind::value i)
  {
    return o << kind::_xsd_kind_literals_[i];
  }

  ::std::ostream&
  operator<< (::std::ostream& o, const kind& i)
  {
