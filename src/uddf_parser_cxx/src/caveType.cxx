...
namespace streit
{
  ...
  const caveType::notes_optional& caveType::
  notes () const
  {
    return this->notes_;
  }

  caveType::notes_optional& caveType::
  notes ()
  {
    return this->notes_;
  }
...
namespace streit
{
  ...
  caveType::
  caveType (const ::xercesc::DOMElement& e,
            ::xml_schema::flags f,
            ::xml_schema::container* c)
  ...
  {
    return new class caveType (*this, f, c);
  }

  caveType& caveType::
  operator= (const caveType& x)
  {
    if (this != &x)
    {
...
{
  ::std::ostream&
  operator<< (::std::ostream& o, const caveType& i)
  {
