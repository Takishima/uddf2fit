...
#ifndef NAMED_TYPE_HXX
#define NAMED_TYPE_HXX
...
namespace streit
{
  class namedType: public ::streit::ID_TYPE
  {
    public:
    // name
    //
    ...
    // aliasname
    //
    typedef ::xml_schema::type aliasname_type;
...
{
  ::std::ostream&
  operator<< (::std::ostream&, const namedType&);
}
