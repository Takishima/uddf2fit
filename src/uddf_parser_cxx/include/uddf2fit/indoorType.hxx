...
#ifndef INDOOR_TYPE_HXX
#define INDOOR_TYPE_HXX
...
namespace streit
{
  class indoorType: public ::streit::simpleNamedType
  {
    public:
    // address
    //
...
{
  ::std::ostream&
  operator<< (::std::ostream&, const indoorType&);
}
