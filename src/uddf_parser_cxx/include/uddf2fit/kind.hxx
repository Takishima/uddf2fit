...
namespace streit
{
  class kind: public ::xml_schema::string
  {
    ...
    public:
    static const char* const _xsd_kind_literals_[2];
    static const value _xsd_kind_indexes_[2];
  };
}
...
{
  ::std::ostream&
  operator<< (::std::ostream&, kind::value);

  ::std::ostream&
  operator<< (::std::ostream&, const kind&);
}
