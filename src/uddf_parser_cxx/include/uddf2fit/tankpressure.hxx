...
#ifndef TANKPRESSURE_HXX
#define TANKPRESSURE_HXX
...
namespace streit
{
  class tankpressure: public ::xsd::cxx::tree::fundamental_base< ::xml_schema::float_, char, ::xml_schema::simple_type >
  {
    public:
    // ref
    //
    ...
    // Constructors.
    //
    tankpressure (const ::xml_schema::float_&);
...
{
  ::std::ostream&
  operator<< (::std::ostream&, const tankpressure&);
}
