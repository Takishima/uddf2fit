...
#ifndef CALCULATETABLE_HXX
#define CALCULATETABLE_HXX
...
namespace streit
{
  class calculatetable: public ::xml_schema::type
  {
    public:
    // table
    //
    typedef ::streit::tableType table_type;
...
{
  ::std::ostream&
  operator<< (::std::ostream&, const calculatetable&);
}
