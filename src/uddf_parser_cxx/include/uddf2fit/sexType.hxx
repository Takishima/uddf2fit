...
namespace streit
{
  class sexType: public ::xml_schema::string
  {
    ...
    public:
    static const char* const _xsd_sexType_literals_[4];
    static const value _xsd_sexType_indexes_[4];
  };
}
...
{
  ::std::ostream&
  operator<< (::std::ostream&, sexType::value);

  ::std::ostream&
  operator<< (::std::ostream&, const sexType&);
}
