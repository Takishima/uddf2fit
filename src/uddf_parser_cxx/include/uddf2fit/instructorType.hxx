...
#ifndef INSTRUCTOR_TYPE_HXX
#define INSTRUCTOR_TYPE_HXX
...
namespace streit
{
  class instructorType: public ::streit::individualType
  {
    public:
    // notes
    //
...
{
  ::std::ostream&
  operator<< (::std::ostream&, const instructorType&);
}
