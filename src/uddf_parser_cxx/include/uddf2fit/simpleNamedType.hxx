...
#ifndef SIMPLE_NAMED_TYPE_HXX
#define SIMPLE_NAMED_TYPE_HXX
...
namespace streit
{
  class simpleNamedType: public ::xml_schema::type
  {
    public:
    // name
    //
    ...
    // Constructors.
    //
    simpleNamedType (const name_type&);
...
{
  ::std::ostream&
  operator<< (::std::ostream&, const simpleNamedType&);
}
