...
#ifndef INSURANCE_TYPE_HXX
#define INSURANCE_TYPE_HXX
...
namespace streit
{
  class insuranceType: public ::xml_schema::type
  {
    public:
    // name
    //
...
{
  ::std::ostream&
  operator<< (::std::ostream&, const insuranceType&);
}
