...
#ifndef EQUIPMENTUSED_HXX
#define EQUIPMENTUSED_HXX
...
namespace streit
{
  class equipmentused: public ::xml_schema::type
  {
    public:
    // leadquantity
    //
    typedef ::xml_schema::float_ leadquantity_type;
    typedef ::xsd::cxx::tree::optional< leadquantity_type > leadquantity_optional;
    typedef ::xsd::cxx::tree::traits< leadquantity_type, char > leadquantity_traits;

    const leadquantity_optional&
    leadquantity () const;

    leadquantity_optional&
    leadquantity ();
    ...
    protected:
    leadquantity_optional leadquantity_;
    link_sequence link_;
  };
}
...
{
  ::std::ostream&
  operator<< (::std::ostream&, const equipmentused&);
}
