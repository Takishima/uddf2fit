...
namespace streit
{
  class purpose: public ::xml_schema::string
  {
...
#ifdef XSD_CXX11
    purpose&
    operator= (const purpose&) = default;
#endif
    ...
    public:
    static const char* const _xsd_purpose_literals_[9];
    static const value _xsd_purpose_indexes_[9];
  };
}
...
{
  ::std::ostream&
  operator<< (::std::ostream&, purpose::value);

  ::std::ostream&
  operator<< (::std::ostream&, const purpose&);
}
