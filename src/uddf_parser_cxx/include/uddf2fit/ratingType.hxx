...
#ifndef RATING_TYPE_HXX
#define RATING_TYPE_HXX
...
namespace streit
{
  class ratingType: public ::xml_schema::type
  {
    ...
    // ratingvalue
    //
    typedef ::streit::ratingvalueType ratingvalue_type;
    ...
    void
    ratingvalue (::std::unique_ptr< ratingvalue_type > p);
...
{
  ::std::ostream&
  operator<< (::std::ostream&, const ratingType&);
}
