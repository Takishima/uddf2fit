...
#ifndef OBSERVATIONS_TYPE_HXX
#define OBSERVATIONS_TYPE_HXX
...
namespace streit
{
  class observationsType: public ::streit::ecologyType
  {
    public:
    // notes
    //
...
{
  ::std::ostream&
  operator<< (::std::ostream&, const observationsType&);
}
