...
#ifndef INPUTPROFILE_TYPE_HXX
#define INPUTPROFILE_TYPE_HXX
...
namespace streit
{
  class inputprofileType: public ::xml_schema::type
  {
    public:
    // link
    //
...
{
  ::std::ostream&
  operator<< (::std::ostream&, const inputprofileType&);
}
