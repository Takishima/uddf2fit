...
#ifndef PRICE_TYPE_HXX
#define PRICE_TYPE_HXX
...
namespace streit
{
  class priceType: public ::xsd::cxx::tree::fundamental_base< ::xml_schema::float_, char, ::xml_schema::simple_type >
  {
    public:
    // currency
    //
    typedef ::streit::currency currency_type;
    ...
    // Constructors.
    //
    priceType (const ::xml_schema::float_&);
...
{
  ::std::ostream&
  operator<< (::std::ostream&, const priceType&);
}
