...
#ifndef DCALARM_WITH_TIME_TYPE_HXX
#define DCALARM_WITH_TIME_TYPE_HXX
...
namespace streit
{
  class dcalarmWithTimeType: public ::streit::encapsulatedDateTimeType
  {
    public:
    // dcalarm
    //
    ...
    // Constructors.
    //
    dcalarmWithTimeType (const datetime_type&,
                         const dcalarm_type&);
...
{
  ::std::ostream&
  operator<< (::std::ostream&, const dcalarmWithTimeType&);
}
...
#endif // DCALARM_WITH_TIME_TYPE_HXX
