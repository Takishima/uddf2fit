...
#ifndef RELATEDDIVES_HXX
#define RELATEDDIVES_HXX
...
namespace streit
{
  class relateddives: public ::xml_schema::type
  {
    public:
    // link
    //
...
{
  ::std::ostream&
  operator<< (::std::ostream&, const relateddives&);
}
