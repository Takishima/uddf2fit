...
from garmin_fit_sdk import BitStream, fit as FIT
...
class TestFromByteArray:
    ...
    @pytest.mark.parametrize(
        'test_data',
        [
            {'data': [0xAA], 'base_type': FIT.BASE_TYPE['UINT8'], 'bits_to_read': [4, 4], 'values': [0xA, 0xA]},
            {'data': [0xAA], 'base_type': FIT.BASE_TYPE['UINT8'], 'bits_to_read': [8], 'values': [0xAA]},
            {'data': [0xAA, 0xAA], 'base_type': FIT.BASE_TYPE['UINT8'], 'bits_to_read': [16], 'values': [0xAAAA]},
            {'data': [0xFF, 0xFF], 'base_type': FIT.BASE_TYPE['UINT8'], 'bits_to_read': [16], 'values': [0xFFFF]},
            {
...
class TestFromInteger:
    ...
    @pytest.mark.parametrize(
        'test_data',
        [
            {'data': 0xAA, 'base_type': FIT.BASE_TYPE['UINT8'], 'bits_to_read': [4], 'values': [0xA]},
            {'data': 0xAA, 'base_type': FIT.BASE_TYPE['UINT8'], 'bits_to_read': [4, 4], 'values': [0xA, 0xA]},
            {
                'data': 0xAA,
                'base_type': FIT.BASE_TYPE['UINT8'],
