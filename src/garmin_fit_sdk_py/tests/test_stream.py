...
def test_stream_from_buffered_reader():
    ...
    buffered_reader = io.BufferedReader(io.BytesIO(bytearray([0x0E, 0x20, 0x8B])))
...
class TestReadValues:
    ...
    class TestStrings:
        ...
        @pytest.mark.parametrize(
            ...
            ids=[
                'Regular String',
                'String w/ Null Terminator',
                'Multibyte String w/o Null Terminator',
                'Multibyte String w/ Null Terminator',
            ],
        )
