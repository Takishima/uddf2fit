...
Profile = {
    'version': {'major': 21, 'minor': 141, 'patch': 0, 'type': 'Release'},
    'common_fields': {'part_index': 250, 'timestamp': 253, 'message_index': 254},
    'messages': {
        0: {
        ...
        20: {
            ...
            'fields': {
                ...
                52: {
                    'num': 52,  # Log cadence and fractional cadence for backwards compatibility
                    'name': 'cadence256',
                    'type': 'uint16',
                    'array': 'false',
                    'scale': [256],
        ...
        164: {
            ...
            'fields': {
                ...
                1: {
                    'num': 1,  # Each time in the array describes the time at which the gyro sample with the corresponding index was taken. Limited to 30 samples in each message. The samples may span across seconds. Array size must match the number of samples in gyro_x and gyro_y and gyro_z
        ...
        165: {
            ...
            'fields': {
                ...
                1: {
                    'num': 1,  # Each time in the array describes the time at which the accelerometer sample with the corresponding index was taken. Limited to 30 samples in each message. The samples may span across seconds. Array size must match the number of samples in accel_x and accel_y and accel_z
                    'name': 'sample_time_offset',
                    'type': 'uint16',
                    'array': 'true',
                    'scale': [1],
        ...
        208: {
            ...
            'fields': {
                ...
                1: {
                    'num': 1,  # Each time in the array describes the time at which the compass sample with the corresponding index was taken. Limited to 30 samples in each message. The samples may span across seconds. Array size must match the number of samples in cmps_x and cmps_y and cmps_z
                    'name': 'sample_time_offset',
                    'type': 'uint16',
                    'array': 'true',
                    'scale': [1],
        ...
        209: {
            ...
            'fields': {
                ...
                1: {
                    'num': 1,  # Each time in the array describes the time at which the barometer sample with the corresponding index was taken. The samples may span across seconds. Array size must match the number of samples in baro_cal
                    'name': 'sample_time_offset',
                    'type': 'uint16',
                    'array': 'true',
                    'scale': [1],
        ...
        174: {
            ...
            'fields': {
                ...
                1: {
                    'num': 1,  # Offset of PID reading [i] from start_timestamp+start_timestamp_ms. Readings may span across seconds.
                    'name': 'time_offset',
                    'type': 'uint16',
                    'array': 'true',
                    'scale': [1],
        ...
        225: {
            ...
            'fields': {
                ...
                3: {
                    'num': 3,  # # of repetitions of the movement
                    'name': 'repetitions',
                    'type': 'uint16',
                    'array': 'false',
                    'scale': [1],
        ...
        150: {
            'num': '150',  # Navigation and race evaluation point for a segment describing a point along the segment path and time it took each segment leader to reach that point
            'name': 'segment_point',
        ...
        314: {
            'num': '314',  # Body battery data used for HAS custom data logging
            'name': 'has_body_battery_data',
            'messages_key': 'has_body_battery_data_mesgs',
            'fields': {
                253: {
                    'num': 253,
                    'name': 'timestamp',
        ...
        302: {
            'num': '302',  # Raw accelerometer data used for HAS custom data logging
            'name': 'has_accelerometer_data',
            'messages_key': 'has_accelerometer_data_mesgs',
            'fields': {
                253: {
                    'num': 253,
                    'name': 'timestamp',
        ...
        376: {
            'num': '376',
            'name': 'has_gyroscope_data',
            'messages_key': 'has_gyroscope_data_mesgs',
            'fields': {
                253: {
                    'num': 253,
                    'name': 'timestamp',
        ...
        304: {
            'num': '304',  # User's current daily step data used for HAS custom data logging
            'name': 'has_step_data',
            'messages_key': 'has_step_data_mesgs',
            'fields': {
                253: {
                    'num': 253,
                    'name': 'timestamp',
        ...
        305: {
            'num': '305',  # User's current SpO2 data used for HAS custom data logging
            'name': 'has_spo2_data',
            'messages_key': 'has_spo2_data_mesgs',
            'fields': {
                253: {
                    'num': 253,
                    'name': 'timestamp',
        ...
        306: {
            'num': '306',  # User's current stress data used for HAS custom data logging
            'name': 'has_stress_data',
            'messages_key': 'has_stress_data_mesgs',
            'fields': {
                253: {
                    'num': 253,
                    'name': 'timestamp',
        ...
        307: {
            'num': '307',  # User's current respiration data used for HAS custom data logging
            'name': 'has_respiration_data',
            'messages_key': 'has_respiration_data_mesgs',
            'fields': {
                253: {
                    'num': 253,
                    'name': 'timestamp',
        ...
        308: {
            'num': '308',  # User's current heart rate data used for HAS custom data logging
            'name': 'has_heart_rate_data',
            'messages_key': 'has_heart_rate_data_mesgs',
            'fields': {
                253: {
                    'num': 253,
                    'name': 'timestamp',
        ...
        389: {
            'num': '389',  # Configuration data for HAS custom data logging
            'name': 'has_configuration_data',
            'messages_key': 'has_configuration_data_mesgs',
            'fields': {
                253: {
        ...
        409: {
            'num': '409',  # Wrist temperature data used for HAS custom data logging
            'name': 'has_wrist_temperature_data',
            'messages_key': 'has_wrist_temperature_data_mesgs',
            'fields': {
                253: {
                    'num': 253,
                    'name': 'timestamp',
    ...
    'types': {
        ...
        'mesg_num': {
            ...
            '302': 'has_accelerometer_data',
            '304': 'has_step_data',
            '305': 'has_spo2_data',
            '306': 'has_stress_data',
            '307': 'has_respiration_data',
            '308': 'has_heart_rate_data',
            '312': 'split',
            '313': 'split_summary',
            '314': 'has_body_battery_data',
            '315': 'has_event',
            '317': 'climb_pro',
            '319': 'tank_update',
            '323': 'tank_summary',
            ...
            '376': 'has_gyroscope_data',
            '387': 'chrono_shot_session',
            '388': 'chrono_shot_data',
            '389': 'has_configuration_data',
            '393': 'dive_apnea_alarm',
            '398': 'skin_temp_overnight',
            '409': 'has_wrist_temperature_data',  # Message number for the HAS wrist temperature data message
        ...
        'connectivity_capabilities': {
            ...
            '0x00100000': 'connect_iq_app_management',  # Device supports delete and reorder of apps via GCM
    ...
    'mesg_num': {
        ...
        'STRESS_LEVEL': 227,
        'MAX_MET_DATA': 229,
        'HAS_BODY_BATTERY_DATA': 314,
        'HAS_EVENT': 315,
        'HAS_ACCELEROMETER_DATA': 302,
        'HAS_GYROSCOPE_DATA': 376,
        'HAS_STEP_DATA': 304,
        'HAS_SPO2_DATA': 305,
        'HAS_STRESS_DATA': 306,
        'HAS_RESPIRATION_DATA': 307,
        'HAS_HEART_RATE_DATA': 308,
        'HAS_CONFIGURATION_DATA': 389,
        'HAS_WRIST_TEMPERATURE_DATA': 409,
        'MEMO_GLOB': 145,
        'SLEEP_LEVEL': 275,
        'ANT_CHANNEL_ID': 82,
        'ANT_RX': 80,
