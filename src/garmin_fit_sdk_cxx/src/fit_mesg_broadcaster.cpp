...
void MesgBroadcaster::RemoveListener(MesgDefinitionListener &mesgDefinitionListener) {
    mesgDefinitionListeners.erase(std::find(
        mesgDefinitionListeners.begin(), mesgDefinitionListeners.end(), &mesgDefinitionListener));
}
...
void MesgBroadcaster::RemoveListener(SoftwareMesgListener &softwareMesgListener) {
    std::vector<SoftwareMesgListener *>::iterator it = std::find(
        softwareMesgListeners.begin(), softwareMesgListeners.end(), &softwareMesgListener);
...
void MesgBroadcaster::RemoveListener(SlaveDeviceMesgListener &slaveDeviceMesgListener) {
    std::vector<SlaveDeviceMesgListener *>::iterator it
        = std::find(slaveDeviceMesgListeners.begin(),
                    slaveDeviceMesgListeners.end(),
                    &slaveDeviceMesgListener);
...
void MesgBroadcaster::RemoveListener(CapabilitiesMesgListener &capabilitiesMesgListener) {
    std::vector<CapabilitiesMesgListener *>::iterator it
        = std::find(capabilitiesMesgListeners.begin(),
                    capabilitiesMesgListeners.end(),
                    &capabilitiesMesgListener);
...
void MesgBroadcaster::RemoveListener(FileCapabilitiesMesgListener &fileCapabilitiesMesgListener) {
    std::vector<FileCapabilitiesMesgListener *>::iterator it
        = std::find(fileCapabilitiesMesgListeners.begin(),
                    fileCapabilitiesMesgListeners.end(),
                    &fileCapabilitiesMesgListener);
...
void MesgBroadcaster::RemoveListener(MesgCapabilitiesMesgListener &mesgCapabilitiesMesgListener) {
    std::vector<MesgCapabilitiesMesgListener *>::iterator it
        = std::find(mesgCapabilitiesMesgListeners.begin(),
                    mesgCapabilitiesMesgListeners.end(),
                    &mesgCapabilitiesMesgListener);
...
void MesgBroadcaster::RemoveListener(
    ...
    std::vector<FieldCapabilitiesMesgListener *>::iterator it
        = std::find(fieldCapabilitiesMesgListeners.begin(),
                    fieldCapabilitiesMesgListeners.end(),
...
void MesgBroadcaster::RemoveListener(DeviceSettingsMesgListener &deviceSettingsMesgListener) {
    std::vector<DeviceSettingsMesgListener *>::iterator it
        = std::find(deviceSettingsMesgListeners.begin(),
                    deviceSettingsMesgListeners.end(),
...
void MesgBroadcaster::RemoveListener(HrmProfileMesgListener &hrmProfileMesgListener) {
    std::vector<HrmProfileMesgListener *>::iterator it = std::find(
        hrmProfileMesgListeners.begin(), hrmProfileMesgListeners.end(), &hrmProfileMesgListener);
...
void MesgBroadcaster::RemoveListener(SdmProfileMesgListener &sdmProfileMesgListener) {
    std::vector<SdmProfileMesgListener *>::iterator it = std::find(
        sdmProfileMesgListeners.begin(), sdmProfileMesgListeners.end(), &sdmProfileMesgListener);
...
void MesgBroadcaster::RemoveListener(BikeProfileMesgListener &bikeProfileMesgListener) {
    std::vector<BikeProfileMesgListener *>::iterator it
        = std::find(bikeProfileMesgListeners.begin(),
                    bikeProfileMesgListeners.end(),
                    &bikeProfileMesgListener);
...
void MesgBroadcaster::RemoveListener(ConnectivityMesgListener &connectivityMesgListener) {
    std::vector<ConnectivityMesgListener *>::iterator it
        = std::find(connectivityMesgListeners.begin(),
                    connectivityMesgListeners.end(),
                    &connectivityMesgListener);
...
void MesgBroadcaster::RemoveListener(
    ...
    std::vector<WatchfaceSettingsMesgListener *>::iterator it
        = std::find(watchfaceSettingsMesgListeners.begin(),
                    watchfaceSettingsMesgListeners.end(),
                    &watchfaceSettingsMesgListener);
...
void MesgBroadcaster::RemoveListener(OhrSettingsMesgListener &ohrSettingsMesgListener) {
    std::vector<OhrSettingsMesgListener *>::iterator it
        = std::find(ohrSettingsMesgListeners.begin(),
                    ohrSettingsMesgListeners.end(),
                    &ohrSettingsMesgListener);
...
void MesgBroadcaster::RemoveListener(TimeInZoneMesgListener &timeInZoneMesgListener) {
    std::vector<TimeInZoneMesgListener *>::iterator it = std::find(
        timeInZoneMesgListeners.begin(), timeInZoneMesgListeners.end(), &timeInZoneMesgListener);
...
void MesgBroadcaster::RemoveListener(ZonesTargetMesgListener &zonesTargetMesgListener) {
    std::vector<ZonesTargetMesgListener *>::iterator it
        = std::find(zonesTargetMesgListeners.begin(),
                    zonesTargetMesgListeners.end(),
                    &zonesTargetMesgListener);
...
void MesgBroadcaster::RemoveListener(SpeedZoneMesgListener &speedZoneMesgListener) {
    std::vector<SpeedZoneMesgListener *>::iterator it = std::find(
        speedZoneMesgListeners.begin(), speedZoneMesgListeners.end(), &speedZoneMesgListener);
...
void MesgBroadcaster::RemoveListener(CadenceZoneMesgListener &cadenceZoneMesgListener) {
    std::vector<CadenceZoneMesgListener *>::iterator it
        = std::find(cadenceZoneMesgListeners.begin(),
                    cadenceZoneMesgListeners.end(),
                    &cadenceZoneMesgListener);
...
void MesgBroadcaster::RemoveListener(PowerZoneMesgListener &powerZoneMesgListener) {
    std::vector<PowerZoneMesgListener *>::iterator it = std::find(
        powerZoneMesgListeners.begin(), powerZoneMesgListeners.end(), &powerZoneMesgListener);
...
void MesgBroadcaster::RemoveListener(MetZoneMesgListener &metZoneMesgListener) {
    std::vector<MetZoneMesgListener *>::iterator it = std::find(
        metZoneMesgListeners.begin(), metZoneMesgListeners.end(), &metZoneMesgListener);
...
void MesgBroadcaster::RemoveListener(DiveSettingsMesgListener &diveSettingsMesgListener) {
    std::vector<DiveSettingsMesgListener *>::iterator it
        = std::find(diveSettingsMesgListeners.begin(),
                    diveSettingsMesgListeners.end(),
                    &diveSettingsMesgListener);
...
void MesgBroadcaster::RemoveListener(DiveAlarmMesgListener &diveAlarmMesgListener) {
    std::vector<DiveAlarmMesgListener *>::iterator it = std::find(
        diveAlarmMesgListeners.begin(), diveAlarmMesgListeners.end(), &diveAlarmMesgListener);
...
void MesgBroadcaster::RemoveListener(DiveApneaAlarmMesgListener &diveApneaAlarmMesgListener) {
    std::vector<DiveApneaAlarmMesgListener *>::iterator it
        = std::find(diveApneaAlarmMesgListeners.begin(),
                    diveApneaAlarmMesgListeners.end(),
                    &diveApneaAlarmMesgListener);
...
void MesgBroadcaster::RemoveListener(DiveGasMesgListener &diveGasMesgListener) {
    std::vector<DiveGasMesgListener *>::iterator it = std::find(
        diveGasMesgListeners.begin(), diveGasMesgListeners.end(), &diveGasMesgListener);
...
void MesgBroadcaster::RemoveListener(ActivityMesgListener &activityMesgListener) {
    std::vector<ActivityMesgListener *>::iterator it = std::find(
        activityMesgListeners.begin(), activityMesgListeners.end(), &activityMesgListener);
...
void MesgBroadcaster::RemoveListener(SessionMesgListener &sessionMesgListener) {
    std::vector<SessionMesgListener *>::iterator it = std::find(
        sessionMesgListeners.begin(), sessionMesgListeners.end(), &sessionMesgListener);
...
void MesgBroadcaster::RemoveListener(DeviceInfoMesgListener &deviceInfoMesgListener) {
    std::vector<DeviceInfoMesgListener *>::iterator it = std::find(
        deviceInfoMesgListeners.begin(), deviceInfoMesgListeners.end(), &deviceInfoMesgListener);
...
void MesgBroadcaster::RemoveListener(TrainingFileMesgListener &trainingFileMesgListener) {
    std::vector<TrainingFileMesgListener *>::iterator it
        = std::find(trainingFileMesgListeners.begin(),
                    trainingFileMesgListeners.end(),
                    &trainingFileMesgListener);
...
void MesgBroadcaster::RemoveListener(
    ...
    std::vector<WeatherConditionsMesgListener *>::iterator it
        = std::find(weatherConditionsMesgListeners.begin(),
                    weatherConditionsMesgListeners.end(),
                    &weatherConditionsMesgListener);
...
void MesgBroadcaster::RemoveListener(WeatherAlertMesgListener &weatherAlertMesgListener) {
    std::vector<WeatherAlertMesgListener *>::iterator it
        = std::find(weatherAlertMesgListeners.begin(),
                    weatherAlertMesgListeners.end(),
                    &weatherAlertMesgListener);
...
void MesgBroadcaster::RemoveListener(GyroscopeDataMesgListener &gyroscopeDataMesgListener) {
    std::vector<GyroscopeDataMesgListener *>::iterator it
        = std::find(gyroscopeDataMesgListeners.begin(),
                    gyroscopeDataMesgListeners.end(),
...
void MesgBroadcaster::RemoveListener(
    ...
    std::vector<AccelerometerDataMesgListener *>::iterator it
        = std::find(accelerometerDataMesgListeners.begin(),
                    accelerometerDataMesgListeners.end(),
...
void MesgBroadcaster::RemoveListener(MagnetometerDataMesgListener &magnetometerDataMesgListener) {
    std::vector<MagnetometerDataMesgListener *>::iterator it
        = std::find(magnetometerDataMesgListeners.begin(),
                    magnetometerDataMesgListeners.end(),
...
void MesgBroadcaster::RemoveListener(BarometerDataMesgListener &barometerDataMesgListener) {
    std::vector<BarometerDataMesgListener *>::iterator it
        = std::find(barometerDataMesgListeners.begin(),
                    barometerDataMesgListeners.end(),
                    &barometerDataMesgListener);
...
void MesgBroadcaster::RemoveListener(VideoFrameMesgListener &videoFrameMesgListener) {
    std::vector<VideoFrameMesgListener *>::iterator it = std::find(
        videoFrameMesgListeners.begin(), videoFrameMesgListeners.end(), &videoFrameMesgListener);
...
void MesgBroadcaster::RemoveListener(ObdiiDataMesgListener &obdiiDataMesgListener) {
    std::vector<ObdiiDataMesgListener *>::iterator it = std::find(
        obdiiDataMesgListeners.begin(), obdiiDataMesgListeners.end(), &obdiiDataMesgListener);
...
void MesgBroadcaster::RemoveListener(AviationAttitudeMesgListener &aviationAttitudeMesgListener) {
    std::vector<AviationAttitudeMesgListener *>::iterator it
        = std::find(aviationAttitudeMesgListeners.begin(),
                    aviationAttitudeMesgListeners.end(),
                    &aviationAttitudeMesgListener);
...
void MesgBroadcaster::RemoveListener(VideoTitleMesgListener &videoTitleMesgListener) {
    std::vector<VideoTitleMesgListener *>::iterator it = std::find(
        videoTitleMesgListeners.begin(), videoTitleMesgListeners.end(), &videoTitleMesgListener);
...
void MesgBroadcaster::RemoveListener(VideoDescriptionMesgListener &videoDescriptionMesgListener) {
    std::vector<VideoDescriptionMesgListener *>::iterator it
        = std::find(videoDescriptionMesgListeners.begin(),
                    videoDescriptionMesgListeners.end(),
                    &videoDescriptionMesgListener);
...
void MesgBroadcaster::RemoveListener(VideoClipMesgListener &videoClipMesgListener) {
    std::vector<VideoClipMesgListener *>::iterator it = std::find(
        videoClipMesgListeners.begin(), videoClipMesgListeners.end(), &videoClipMesgListener);
...
void MesgBroadcaster::RemoveListener(SplitSummaryMesgListener &splitSummaryMesgListener) {
    std::vector<SplitSummaryMesgListener *>::iterator it
        = std::find(splitSummaryMesgListeners.begin(),
                    splitSummaryMesgListeners.end(),
                    &splitSummaryMesgListener);
...
void MesgBroadcaster::RemoveListener(ClimbProMesgListener &climbProMesgListener) {
    std::vector<ClimbProMesgListener *>::iterator it = std::find(
        climbProMesgListeners.begin(), climbProMesgListeners.end(), &climbProMesgListener);
...
void MesgBroadcaster::RemoveListener(FieldDescriptionMesgListener &fieldDescriptionMesgListener) {
    std::vector<FieldDescriptionMesgListener *>::iterator it
        = std::find(fieldDescriptionMesgListeners.begin(),
                    fieldDescriptionMesgListeners.end(),
                    &fieldDescriptionMesgListener);
...
void MesgBroadcaster::RemoveListener(DeveloperDataIdMesgListener &developerDataIdMesgListener) {
    std::vector<DeveloperDataIdMesgListener *>::iterator it
        = std::find(developerDataIdMesgListeners.begin(),
                    developerDataIdMesgListeners.end(),
...
void MesgBroadcaster::RemoveListener(SegmentIdMesgListener &segmentIdMesgListener) {
    std::vector<SegmentIdMesgListener *>::iterator it = std::find(
        segmentIdMesgListeners.begin(), segmentIdMesgListeners.end(), &segmentIdMesgListener);
...
void MesgBroadcaster::RemoveListener(SegmentPointMesgListener &segmentPointMesgListener) {
    std::vector<SegmentPointMesgListener *>::iterator it
        = std::find(segmentPointMesgListeners.begin(),
                    segmentPointMesgListeners.end(),
                    &segmentPointMesgListener);
...
void MesgBroadcaster::RemoveListener(SegmentLapMesgListener &segmentLapMesgListener) {
    std::vector<SegmentLapMesgListener *>::iterator it = std::find(
        segmentLapMesgListeners.begin(), segmentLapMesgListeners.end(), &segmentLapMesgListener);
...
void MesgBroadcaster::RemoveListener(SegmentFileMesgListener &segmentFileMesgListener) {
    std::vector<SegmentFileMesgListener *>::iterator it
        = std::find(segmentFileMesgListeners.begin(),
                    segmentFileMesgListeners.end(),
                    &segmentFileMesgListener);
...
void MesgBroadcaster::RemoveListener(WorkoutMesgListener &workoutMesgListener) {
    std::vector<WorkoutMesgListener *>::iterator it = std::find(
        workoutMesgListeners.begin(), workoutMesgListeners.end(), &workoutMesgListener);
...
void MesgBroadcaster::RemoveListener(WorkoutSessionMesgListener &workoutSessionMesgListener) {
    std::vector<WorkoutSessionMesgListener *>::iterator it
        = std::find(workoutSessionMesgListeners.begin(),
                    workoutSessionMesgListeners.end(),
                    &workoutSessionMesgListener);
...
void MesgBroadcaster::RemoveListener(ExerciseTitleMesgListener &exerciseTitleMesgListener) {
    std::vector<ExerciseTitleMesgListener *>::iterator it
        = std::find(exerciseTitleMesgListeners.begin(),
                    exerciseTitleMesgListeners.end(),
...
void MesgBroadcaster::RemoveListener(ScheduleMesgListener &scheduleMesgListener) {
    std::vector<ScheduleMesgListener *>::iterator it = std::find(
        scheduleMesgListeners.begin(), scheduleMesgListeners.end(), &scheduleMesgListener);
...
void MesgBroadcaster::RemoveListener(WeightScaleMesgListener &weightScaleMesgListener) {
    std::vector<WeightScaleMesgListener *>::iterator it
        = std::find(weightScaleMesgListeners.begin(),
                    weightScaleMesgListeners.end(),
                    &weightScaleMesgListener);
...
void MesgBroadcaster::RemoveListener(BloodPressureMesgListener &bloodPressureMesgListener) {
    std::vector<BloodPressureMesgListener *>::iterator it
        = std::find(bloodPressureMesgListeners.begin(),
                    bloodPressureMesgListeners.end(),
                    &bloodPressureMesgListener);
...
void MesgBroadcaster::RemoveListener(MonitoringInfoMesgListener &monitoringInfoMesgListener) {
    std::vector<MonitoringInfoMesgListener *>::iterator it
        = std::find(monitoringInfoMesgListeners.begin(),
                    monitoringInfoMesgListeners.end(),
                    &monitoringInfoMesgListener);
...
void MesgBroadcaster::RemoveListener(MonitoringMesgListener &monitoringMesgListener) {
    std::vector<MonitoringMesgListener *>::iterator it = std::find(
        monitoringMesgListeners.begin(), monitoringMesgListeners.end(), &monitoringMesgListener);
...
void MesgBroadcaster::RemoveListener(MonitoringHrDataMesgListener &monitoringHrDataMesgListener) {
    std::vector<MonitoringHrDataMesgListener *>::iterator it
        = std::find(monitoringHrDataMesgListeners.begin(),
                    monitoringHrDataMesgListeners.end(),
                    &monitoringHrDataMesgListener);
...
void MesgBroadcaster::RemoveListener(Spo2DataMesgListener &spo2DataMesgListener) {
    std::vector<Spo2DataMesgListener *>::iterator it = std::find(
        spo2DataMesgListeners.begin(), spo2DataMesgListeners.end(), &spo2DataMesgListener);
...
void MesgBroadcaster::RemoveListener(StressLevelMesgListener &stressLevelMesgListener) {
    std::vector<StressLevelMesgListener *>::iterator it
        = std::find(stressLevelMesgListeners.begin(),
                    stressLevelMesgListeners.end(),
                    &stressLevelMesgListener);
...
void MesgBroadcaster::RemoveListener(MaxMetDataMesgListener &maxMetDataMesgListener) {
    std::vector<MaxMetDataMesgListener *>::iterator it = std::find(
        maxMetDataMesgListeners.begin(), maxMetDataMesgListeners.end(), &maxMetDataMesgListener);
...
void MesgBroadcaster::RemoveListener(
    HsaBodyBatteryDataMesgListener &hsaBodyBatteryDataMesgListener) {
    std::vector<HsaBodyBatteryDataMesgListener *>::iterator it
        = std::find(hsaBodyBatteryDataMesgListeners.begin(),
                    hsaBodyBatteryDataMesgListeners.end(),
...
void MesgBroadcaster::RemoveListener(HsaEventMesgListener &hsaEventMesgListener) {
    std::vector<HsaEventMesgListener *>::iterator it = std::find(
        hsaEventMesgListeners.begin(), hsaEventMesgListeners.end(), &hsaEventMesgListener);
    if (hsaEventMesgListeners.end() != it)
        hsaEventMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    HsaAccelerometerDataMesgListener &hsaAccelerometerDataMesgListener) {
...
void MesgBroadcaster::RemoveListener(
    ...
    std::vector<HsaAccelerometerDataMesgListener *>::iterator it
        = std::find(hsaAccelerometerDataMesgListeners.begin(),
                    hsaAccelerometerDataMesgListeners.end(),
...
void MesgBroadcaster::RemoveListener(HsaGyroscopeDataMesgListener &hsaGyroscopeDataMesgListener) {
    std::vector<HsaGyroscopeDataMesgListener *>::iterator it
        = std::find(hsaGyroscopeDataMesgListeners.begin(),
                    hsaGyroscopeDataMesgListeners.end(),
                    &hsaGyroscopeDataMesgListener);
...
void MesgBroadcaster::RemoveListener(HsaStepDataMesgListener &hsaStepDataMesgListener) {
    std::vector<HsaStepDataMesgListener *>::iterator it
        = std::find(hsaStepDataMesgListeners.begin(),
                    hsaStepDataMesgListeners.end(),
                    &hsaStepDataMesgListener);
...
void MesgBroadcaster::RemoveListener(HsaSpo2DataMesgListener &hsaSpo2DataMesgListener) {
    std::vector<HsaSpo2DataMesgListener *>::iterator it
        = std::find(hsaSpo2DataMesgListeners.begin(),
                    hsaSpo2DataMesgListeners.end(),
                    &hsaSpo2DataMesgListener);
...
void MesgBroadcaster::RemoveListener(HsaStressDataMesgListener &hsaStressDataMesgListener) {
    std::vector<HsaStressDataMesgListener *>::iterator it
        = std::find(hsaStressDataMesgListeners.begin(),
                    hsaStressDataMesgListeners.end(),
                    &hsaStressDataMesgListener);
...
void MesgBroadcaster::RemoveListener(
    HsaRespirationDataMesgListener &hsaRespirationDataMesgListener) {
    std::vector<HsaRespirationDataMesgListener *>::iterator it
        = std::find(hsaRespirationDataMesgListeners.begin(),
                    hsaRespirationDataMesgListeners.end(),
...
void MesgBroadcaster::RemoveListener(HsaHeartRateDataMesgListener &hsaHeartRateDataMesgListener) {
    std::vector<HsaHeartRateDataMesgListener *>::iterator it
        = std::find(hsaHeartRateDataMesgListeners.begin(),
                    hsaHeartRateDataMesgListeners.end(),
                    &hsaHeartRateDataMesgListener);
    if (hsaHeartRateDataMesgListeners.end() != it)
        hsaHeartRateDataMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    HsaConfigurationDataMesgListener &hsaConfigurationDataMesgListener) {
...
void MesgBroadcaster::RemoveListener(
    ...
    std::vector<HsaConfigurationDataMesgListener *>::iterator it
        = std::find(hsaConfigurationDataMesgListeners.begin(),
                    hsaConfigurationDataMesgListeners.end(),
...
void MesgBroadcaster::AddListener(
    HsaWristTemperatureDataMesgListener &hsaWristTemperatureDataMesgListener) {
...
void MesgBroadcaster::RemoveListener(
    ...
    std::vector<HsaWristTemperatureDataMesgListener *>::iterator it
        = std::find(hsaWristTemperatureDataMesgListeners.begin(),
                    hsaWristTemperatureDataMesgListeners.end(),
...
void MesgBroadcaster::RemoveListener(MemoGlobMesgListener &memoGlobMesgListener) {
    std::vector<MemoGlobMesgListener *>::iterator it = std::find(
        memoGlobMesgListeners.begin(), memoGlobMesgListeners.end(), &memoGlobMesgListener);
...
void MesgBroadcaster::RemoveListener(SleepLevelMesgListener &sleepLevelMesgListener) {
    std::vector<SleepLevelMesgListener *>::iterator it = std::find(
        sleepLevelMesgListeners.begin(), sleepLevelMesgListeners.end(), &sleepLevelMesgListener);
...
void MesgBroadcaster::RemoveListener(AntChannelIdMesgListener &antChannelIdMesgListener) {
    std::vector<AntChannelIdMesgListener *>::iterator it
        = std::find(antChannelIdMesgListeners.begin(),
                    antChannelIdMesgListeners.end(),
                    &antChannelIdMesgListener);
...
void MesgBroadcaster::AddListener(
    ExdDataFieldConfigurationMesgListener &exdDataFieldConfigurationMesgListener) {
...
void MesgBroadcaster::AddListener(
    ExdDataConceptConfigurationMesgListener &exdDataConceptConfigurationMesgListener) {
...
void MesgBroadcaster::RemoveListener(DiveSummaryMesgListener &diveSummaryMesgListener) {
    std::vector<DiveSummaryMesgListener *>::iterator it
        = std::find(diveSummaryMesgListeners.begin(),
                    diveSummaryMesgListeners.end(),
                    &diveSummaryMesgListener);
...
void MesgBroadcaster::RemoveListener(AadAccelFeaturesMesgListener &aadAccelFeaturesMesgListener) {
    std::vector<AadAccelFeaturesMesgListener *>::iterator it
        = std::find(aadAccelFeaturesMesgListeners.begin(),
                    aadAccelFeaturesMesgListeners.end(),
                    &aadAccelFeaturesMesgListener);
...
void MesgBroadcaster::RemoveListener(BeatIntervalsMesgListener &beatIntervalsMesgListener) {
    std::vector<BeatIntervalsMesgListener *>::iterator it
        = std::find(beatIntervalsMesgListeners.begin(),
                    beatIntervalsMesgListeners.end(),
                    &beatIntervalsMesgListener);
...
void MesgBroadcaster::RemoveListener(HrvStatusSummaryMesgListener &hrvStatusSummaryMesgListener) {
    std::vector<HrvStatusSummaryMesgListener *>::iterator it
        = std::find(hrvStatusSummaryMesgListeners.begin(),
                    hrvStatusSummaryMesgListeners.end(),
...
void MesgBroadcaster::RemoveListener(HrvValueMesgListener &hrvValueMesgListener) {
    std::vector<HrvValueMesgListener *>::iterator it = std::find(
        hrvValueMesgListeners.begin(), hrvValueMesgListeners.end(), &hrvValueMesgListener);
...
void MesgBroadcaster::RemoveListener(RespirationRateMesgListener &respirationRateMesgListener) {
    std::vector<RespirationRateMesgListener *>::iterator it
        = std::find(respirationRateMesgListeners.begin(),
                    respirationRateMesgListeners.end(),
...
void MesgBroadcaster::RemoveListener(
    ChronoShotSessionMesgListener &chronoShotSessionMesgListener) {
    std::vector<ChronoShotSessionMesgListener *>::iterator it
        = std::find(chronoShotSessionMesgListeners.begin(),
                    chronoShotSessionMesgListeners.end(),
                    &chronoShotSessionMesgListener);
...
void MesgBroadcaster::RemoveListener(ChronoShotDataMesgListener &chronoShotDataMesgListener) {
    std::vector<ChronoShotDataMesgListener *>::iterator it
        = std::find(chronoShotDataMesgListeners.begin(),
                    chronoShotDataMesgListeners.end(),
...
void MesgBroadcaster::RemoveListener(TankUpdateMesgListener &tankUpdateMesgListener) {
    std::vector<TankUpdateMesgListener *>::iterator it = std::find(
        tankUpdateMesgListeners.begin(), tankUpdateMesgListeners.end(), &tankUpdateMesgListener);
...
void MesgBroadcaster::RemoveListener(TankSummaryMesgListener &tankSummaryMesgListener) {
    std::vector<TankSummaryMesgListener *>::iterator it
        = std::find(tankSummaryMesgListeners.begin(),
                    tankSummaryMesgListeners.end(),
                    &tankSummaryMesgListener);
...
void MesgBroadcaster::RemoveListener(SleepAssessmentMesgListener &sleepAssessmentMesgListener) {
    std::vector<SleepAssessmentMesgListener *>::iterator it
        = std::find(sleepAssessmentMesgListeners.begin(),
                    sleepAssessmentMesgListeners.end(),
...
void MesgBroadcaster::RemoveListener(
    SkinTempOvernightMesgListener &skinTempOvernightMesgListener) {
    std::vector<SkinTempOvernightMesgListener *>::iterator it
        = std::find(skinTempOvernightMesgListeners.begin(),
                    skinTempOvernightMesgListeners.end(),
                    &skinTempOvernightMesgListener);
