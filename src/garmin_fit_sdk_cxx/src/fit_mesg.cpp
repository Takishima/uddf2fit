...
int Mesg::Write(std::ostream &file, const MesgDefinition *mesgDef) const {
    ...
    for (FIT_UINT16 fieldDefIndex = 0; fieldDefIndex < (mesgDef->GetFields().size());
         fieldDefIndex++) {
...
const std::vector<DeveloperField> &Mesg::GetDeveloperFields() const { return devFields; }
...
void Mesg::SetFieldENUMValue(const FIT_UINT8 fieldNum,
...
void Mesg::SetFieldBYTEValue(const FIT_UINT8 fieldNum,
...
void Mesg::SetFieldSINT8Value(const FIT_UINT8 fieldNum,
...
void Mesg::SetFieldUINT8Value(const FIT_UINT8 fieldNum,
...
void Mesg::SetFieldUINT8ZValue(const FIT_UINT8 fieldNum,
                               const FIT_UINT8 value,
                               const FIT_UINT8 fieldArrayIndex,
                               const FIT_UINT16 subFieldIndex) {
    if (!CanSupportSubField(fieldNum, subFieldIndex))
...
void Mesg::SetFieldSINT16Value(const FIT_UINT8 fieldNum,
...
void Mesg::SetFieldUINT16Value(const FIT_UINT8 fieldNum,
...
void Mesg::SetFieldSINT32Value(const FIT_UINT8 fieldNum,
...
void Mesg::SetFieldUINT32Value(const FIT_UINT8 fieldNum,
...
void Mesg::SetFieldSINT64Value(const FIT_UINT8 fieldNum,
...
void Mesg::SetFieldUINT64Value(const FIT_UINT8 fieldNum,
...
int Mesg::WriteField(std::ostream &file,
