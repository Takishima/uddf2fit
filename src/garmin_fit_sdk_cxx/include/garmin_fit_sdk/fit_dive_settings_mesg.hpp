...
public:
    ...
    FIT_BOOL IsHeartRateLocalDeviceTypeValid() const {
        ...
        return field->IsValueValid(
            0,
            (FIT_UINT16)
                Profile::DIVE_SETTINGS_MESG_HEART_RATE_SOURCE_FIELD_HEART_RATE_LOCAL_DEVICE_TYPE);
    }
    ...
    // Comment: Type of gas consumption rate to display. Some values are only valid if tank volume
    // is known.
    ///////////////////////////////////////////////////////////////////////
