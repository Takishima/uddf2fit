...
public:
    ...
    void SetTimerTrigger(FIT_TIMER_TRIGGER timerTrigger) {
        SetFieldENUMValue(
            3, timerTrigger, 0, (FIT_UINT16) Profile::EVENT_MESG_DATA_FIELD_TIMER_TRIGGER);
    }
    ...
    void SetBatteryLevel(FIT_FLOAT32 batteryLevel) {
        SetFieldFLOAT32Value(
            3, batteryLevel, 0, (FIT_UINT16) Profile::EVENT_MESG_DATA_FIELD_BATTERY_LEVEL);
    }
    ...
    FIT_BOOL IsVirtualPartnerSpeedValid() const {
        ...
        if (!CanSupportSubField(
                field, (FIT_UINT16) Profile::EVENT_MESG_DATA_FIELD_VIRTUAL_PARTNER_SPEED)) {
            return FIT_FALSE;
        }
    ...
    void SetHrHighAlert(FIT_UINT8 hrHighAlert) {
        SetFieldUINT8Value(
            3, hrHighAlert, 0, (FIT_UINT16) Profile::EVENT_MESG_DATA_FIELD_HR_HIGH_ALERT);
    }
    ...
    void SetHrLowAlert(FIT_UINT8 hrLowAlert) {
        SetFieldUINT8Value(
            3, hrLowAlert, 0, (FIT_UINT16) Profile::EVENT_MESG_DATA_FIELD_HR_LOW_ALERT);
    }
    ...
    void SetSpeedHighAlert(FIT_FLOAT32 speedHighAlert) {
        SetFieldFLOAT32Value(
            3, speedHighAlert, 0, (FIT_UINT16) Profile::EVENT_MESG_DATA_FIELD_SPEED_HIGH_ALERT);
    }
    ...
    void SetSpeedLowAlert(FIT_FLOAT32 speedLowAlert) {
        SetFieldFLOAT32Value(
            3, speedLowAlert, 0, (FIT_UINT16) Profile::EVENT_MESG_DATA_FIELD_SPEED_LOW_ALERT);
    }
    ...
    void SetCadHighAlert(FIT_UINT16 cadHighAlert) {
        SetFieldUINT16Value(
            3, cadHighAlert, 0, (FIT_UINT16) Profile::EVENT_MESG_DATA_FIELD_CAD_HIGH_ALERT);
    }
    ...
    void SetCadLowAlert(FIT_UINT16 cadLowAlert) {
        SetFieldUINT16Value(
            3, cadLowAlert, 0, (FIT_UINT16) Profile::EVENT_MESG_DATA_FIELD_CAD_LOW_ALERT);
    }
    ...
    void SetPowerHighAlert(FIT_UINT16 powerHighAlert) {
        SetFieldUINT16Value(
            3, powerHighAlert, 0, (FIT_UINT16) Profile::EVENT_MESG_DATA_FIELD_POWER_HIGH_ALERT);
    }
    ...
    void SetPowerLowAlert(FIT_UINT16 powerLowAlert) {
        SetFieldUINT16Value(
            3, powerLowAlert, 0, (FIT_UINT16) Profile::EVENT_MESG_DATA_FIELD_POWER_LOW_ALERT);
    }
    ...
    FIT_BOOL IsDistanceDurationAlertValid() const {
        ...
        if (!CanSupportSubField(
                field, (FIT_UINT16) Profile::EVENT_MESG_DATA_FIELD_DISTANCE_DURATION_ALERT)) {
            return FIT_FALSE;
        }
    ...
    FIT_FLOAT32 GetDistanceDurationAlert(void) const {
        return GetFieldFLOAT32Value(
            3, 0, (FIT_UINT16) Profile::EVENT_MESG_DATA_FIELD_DISTANCE_DURATION_ALERT);
    }
    ...
    FIT_BOOL IsCalorieDurationAlertValid() const {
        ...
        if (!CanSupportSubField(
                field, (FIT_UINT16) Profile::EVENT_MESG_DATA_FIELD_CALORIE_DURATION_ALERT)) {
            return FIT_FALSE;
        }
    ...
    FIT_UINT32 GetCalorieDurationAlert(void) const {
        return GetFieldUINT32Value(
            3, 0, (FIT_UINT16) Profile::EVENT_MESG_DATA_FIELD_CALORIE_DURATION_ALERT);
    }
    ...
    FIT_BOOL IsFitnessEquipmentStateValid() const {
        ...
        if (!CanSupportSubField(
                field, (FIT_UINT16) Profile::EVENT_MESG_DATA_FIELD_FITNESS_EQUIPMENT_STATE)) {
            return FIT_FALSE;
        }
    ...
    FIT_FITNESS_EQUIPMENT_STATE GetFitnessEquipmentState(void) const {
        return GetFieldENUMValue(
            3, 0, (FIT_UINT16) Profile::EVENT_MESG_DATA_FIELD_FITNESS_EQUIPMENT_STATE);
    }
    ...
    void SetSportPoint(FIT_UINT32 sportPoint) {
        SetFieldUINT32Value(
            3, sportPoint, 0, (FIT_UINT16) Profile::EVENT_MESG_DATA_FIELD_SPORT_POINT);
    }
    ...
    void SetGearChangeData(FIT_UINT32 gearChangeData) {
        SetFieldUINT32Value(
            3, gearChangeData, 0, (FIT_UINT16) Profile::EVENT_MESG_DATA_FIELD_GEAR_CHANGE_DATA);
    }
    ...
    void SetRiderPosition(FIT_RIDER_POSITION_TYPE riderPosition) {
        SetFieldENUMValue(
            3, riderPosition, 0, (FIT_UINT16) Profile::EVENT_MESG_DATA_FIELD_RIDER_POSITION);
    }
    ...
    void SetCommTimeout(FIT_COMM_TIMEOUT_TYPE commTimeout) {
        SetFieldUINT16Value(
            3, commTimeout, 0, (FIT_UINT16) Profile::EVENT_MESG_DATA_FIELD_COMM_TIMEOUT);
    }
    ...
    FIT_BOOL IsAutoActivityDetectDurationValid() const {
        ...
        return field->IsValueValid(
            0, (FIT_UINT16) Profile::EVENT_MESG_DATA_FIELD_AUTO_ACTIVITY_DETECT_DURATION);
    }
    ...
    FIT_UINT16 GetAutoActivityDetectDuration(void) const {
        return GetFieldUINT16Value(
            3, 0, (FIT_UINT16) Profile::EVENT_MESG_DATA_FIELD_AUTO_ACTIVITY_DETECT_DURATION);
    }
    ...
    // Comment: The first byte is the radar_threat_level_max, the second byte is the
    // radar_threat_count, third bytes is the average approach speed, and the 4th byte is the max
    // approach speed
    ///////////////////////////////////////////////////////////////////////
    ...
    ///////////////////////////////////////////////////////////////////////
    // Returns score field
    // Comment: Do not populate directly. Autogenerated by decoder for sport_point subfield
    // components
    ///////////////////////////////////////////////////////////////////////
    ...
    // Comment: Do not populate directly. Autogenerated by decoder for gear_change subfield
    // components. Front gear number. 1 is innermost.
    ///////////////////////////////////////////////////////////////////////
    ...
    // Comment: Do not populate directly. Autogenerated by decoder for gear_change subfield
    // components. Number of front teeth.
    ///////////////////////////////////////////////////////////////////////
    ...
    // Comment: Do not populate directly. Autogenerated by decoder for gear_change subfield
    // components. Rear gear number. 1 is innermost.
    ///////////////////////////////////////////////////////////////////////
    ...
    // Comment: Do not populate directly. Autogenerated by decoder for gear_change subfield
    // components. Number of rear teeth.
    ///////////////////////////////////////////////////////////////////////
    ...
    FIT_BOOL IsAutoActivityDetectStartTimestampValid() const {
        ...
        return field->IsValueValid(
            0,
            (FIT_UINT16)
                Profile::EVENT_MESG_START_TIMESTAMP_FIELD_AUTO_ACTIVITY_DETECT_START_TIMESTAMP);
    }
    ...
    // Comment: Do not populate directly. Autogenerated by decoder for threat_alert subfield
    // components.
    ///////////////////////////////////////////////////////////////////////
    ...
    // Units: m/s
    // Comment: Do not populate directly. Autogenerated by decoder for radar_threat_alert subfield
    // components
    ///////////////////////////////////////////////////////////////////////
