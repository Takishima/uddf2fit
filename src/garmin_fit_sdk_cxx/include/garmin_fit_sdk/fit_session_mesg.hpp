...
public:
    ...
    FIT_BOOL IsTotalStridesValid() const {
        ...
        if (!CanSupportSubField(
                field, (FIT_UINT16) Profile::SESSION_MESG_TOTAL_CYCLES_FIELD_TOTAL_STRIDES)) {
            return FIT_FALSE;
        }
    ...
    FIT_UINT32 GetTotalStrides(void) const {
        return GetFieldUINT32Value(
            10, 0, (FIT_UINT16) Profile::SESSION_MESG_TOTAL_CYCLES_FIELD_TOTAL_STRIDES);
    }
    ...
    FIT_BOOL IsTotalStrokesValid() const {
        ...
        if (!CanSupportSubField(
                field, (FIT_UINT16) Profile::SESSION_MESG_TOTAL_CYCLES_FIELD_TOTAL_STROKES)) {
            return FIT_FALSE;
        }
    ...
    FIT_UINT32 GetTotalStrokes(void) const {
        return GetFieldUINT32Value(
            10, 0, (FIT_UINT16) Profile::SESSION_MESG_TOTAL_CYCLES_FIELD_TOTAL_STROKES);
    }
    ...
    // Units: rpm
    // Comment: total_cycles / total_timer_time if non_zero_avg_cadence otherwise total_cycles /
    // total_elapsed_time
    ///////////////////////////////////////////////////////////////////////
    ...
    FIT_BOOL IsAvgRunningCadenceValid() const {
        ...
        if (!CanSupportSubField(
                field, (FIT_UINT16) Profile::SESSION_MESG_AVG_CADENCE_FIELD_AVG_RUNNING_CADENCE)) {
            return FIT_FALSE;
        }

        return field->IsValueValid(
            0, (FIT_UINT16) Profile::SESSION_MESG_AVG_CADENCE_FIELD_AVG_RUNNING_CADENCE);
    }
    ...
    FIT_UINT8 GetAvgRunningCadence(void) const {
        return GetFieldUINT8Value(
            18, 0, (FIT_UINT16) Profile::SESSION_MESG_AVG_CADENCE_FIELD_AVG_RUNNING_CADENCE);
    }
    ...
    FIT_BOOL IsMaxRunningCadenceValid() const {
        ...
        if (!CanSupportSubField(
                field, (FIT_UINT16) Profile::SESSION_MESG_MAX_CADENCE_FIELD_MAX_RUNNING_CADENCE)) {
            return FIT_FALSE;
        }

        return field->IsValueValid(
            0, (FIT_UINT16) Profile::SESSION_MESG_MAX_CADENCE_FIELD_MAX_RUNNING_CADENCE);
    }
    ...
    FIT_UINT8 GetMaxRunningCadence(void) const {
        return GetFieldUINT8Value(
            19, 0, (FIT_UINT16) Profile::SESSION_MESG_MAX_CADENCE_FIELD_MAX_RUNNING_CADENCE);
    }
    ...
    // Units: watts
    // Comment: total_power / total_timer_time if non_zero_avg_power otherwise total_power /
    // total_elapsed_time
    ///////////////////////////////////////////////////////////////////////
    ...
    ///////////////////////////////////////////////////////////////////////
    void SetOpponentName(FIT_WSTRING opponentName) { SetFieldSTRINGValue(84, opponentName, 0); }
    ...
    // Comment: Avg percentage of hemoglobin saturated with oxygen
    ///////////////////////////////////////////////////////////////////////
    void SetAvgSaturatedHemoglobinPercent(FIT_UINT8 index,
                                          FIT_FLOAT32 avgSaturatedHemoglobinPercent) {
        SetFieldFLOAT32Value(
            98, avgSaturatedHemoglobinPercent, index, FIT_SUBFIELD_INDEX_MAIN_FIELD);
    }
    ...
    // Comment: Min percentage of hemoglobin saturated with oxygen
    ///////////////////////////////////////////////////////////////////////
    void SetMinSaturatedHemoglobinPercent(FIT_UINT8 index,
                                          FIT_FLOAT32 minSaturatedHemoglobinPercent) {
        SetFieldFLOAT32Value(
            99, minSaturatedHemoglobinPercent, index, FIT_SUBFIELD_INDEX_MAIN_FIELD);
    }
    ...
    // Comment: Max percentage of hemoglobin saturated with oxygen
    ///////////////////////////////////////////////////////////////////////
    void SetMaxSaturatedHemoglobinPercent(FIT_UINT8 index,
                                          FIT_FLOAT32 maxSaturatedHemoglobinPercent) {
        SetFieldFLOAT32Value(
            100, maxSaturatedHemoglobinPercent, index, FIT_SUBFIELD_INDEX_MAIN_FIELD);
    }
    ...
    // Units: degrees
    // Comment: Average left power phase peak angles. Data value indexes defined by
    // power_phase_type.
    ///////////////////////////////////////////////////////////////////////
    ...
    // Units: degrees
    // Comment: Average right power phase peak angles data value indexes defined by
    // power_phase_type.
    ///////////////////////////////////////////////////////////////////////
    ...
    // Units: kGrit
    // Comment: The grit score estimates how challenging a route could be for a cyclist in terms of
    // time spent going over sharp turns or large grade slopes.
    ///////////////////////////////////////////////////////////////////////
    ...
    // Units: Flow
    // Comment: The flow score estimates how long distance wise a cyclist deaccelerates over
    // intervals where deacceleration is unnecessary such as smooth turns or small grade angle
    // intervals.
    ///////////////////////////////////////////////////////////////////////
    ...
    // Comment: A 0-100 scale representing how a user felt while performing a workout. Low values
    // are considered feeling bad, while high values are good.
    ///////////////////////////////////////////////////////////////////////
    ...
    // Comment: Common Borg CR10 / 0-10 RPE scale, multiplied 10x.. Aggregate score for all
    ...
    // Units: mS
    // Comment: Standard deviation of R-R interval (SDRR) - Heart rate variability measure most
    // useful for wellness users.
    ///////////////////////////////////////////////////////////////////////
    ...
    // Units: mS
    // Comment: Root mean square successive difference (RMSSD) - Heart rate variability measure
    // most useful for athletes
    ///////////////////////////////////////////////////////////////////////
