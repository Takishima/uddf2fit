...
public:
    ...
    FIT_BOOL IsTotalStrokesValid() const {
        ...
        if (!CanSupportSubField(
                field, (FIT_UINT16) Profile::SEGMENT_LAP_MESG_TOTAL_CYCLES_FIELD_TOTAL_STROKES)) {
            return FIT_FALSE;
        }

        return field->IsValueValid(
            0, (FIT_UINT16) Profile::SEGMENT_LAP_MESG_TOTAL_CYCLES_FIELD_TOTAL_STROKES);
    }
    ...
    FIT_UINT32 GetTotalStrokes(void) const {
        return GetFieldUINT32Value(
            10, 0, (FIT_UINT16) Profile::SEGMENT_LAP_MESG_TOTAL_CYCLES_FIELD_TOTAL_STROKES);
    }
