...
public:
    ...
    // Units: ms
    // Comment: Each time in the array describes the time at which the compass sample with the
    // corrosponding index was taken. Limited to 30 samples in each message. The samples may span
    // across seconds. Array size must match the number of samples in cmps_x and cmps_y and cmps_z
    ///////////////////////////////////////////////////////////////////////
