...
public:
    ...
    FIT_BOOL IsFaveroProductValid() const {
        ...
        if (!CanSupportSubField(
                field, (FIT_UINT16) Profile::SCHEDULE_MESG_PRODUCT_FIELD_FAVERO_PRODUCT)) {
            return FIT_FALSE;
        }
    ...
    void SetFaveroProduct(FIT_FAVERO_PRODUCT faveroProduct) {
        SetFieldUINT16Value(
            1, faveroProduct, 0, (FIT_UINT16) Profile::SCHEDULE_MESG_PRODUCT_FIELD_FAVERO_PRODUCT);
    }
    ...
    FIT_BOOL IsGarminProductValid() const {
        ...
        if (!CanSupportSubField(
                field, (FIT_UINT16) Profile::SCHEDULE_MESG_PRODUCT_FIELD_GARMIN_PRODUCT)) {
            return FIT_FALSE;
        }
    ...
    void SetGarminProduct(FIT_GARMIN_PRODUCT garminProduct) {
        SetFieldUINT16Value(
            1, garminProduct, 0, (FIT_UINT16) Profile::SCHEDULE_MESG_PRODUCT_FIELD_GARMIN_PRODUCT);
    }
