...
public:
    ...
    // Returns type field
    ///////////////////////////////////////////////////////////////////////
    FIT_FILE GetType(void) const { return GetFieldENUMValue(0, 0, FIT_SUBFIELD_INDEX_MAIN_FIELD); }

    ///////////////////////////////////////////////////////////////////////
    // Set type field
    ///////////////////////////////////////////////////////////////////////
    void SetType(FIT_FILE type) { SetFieldENUMValue(0, type, 0, FIT_SUBFIELD_INDEX_MAIN_FIELD); }
    ...
    FIT_BOOL IsFaveroProductValid() const {
        ...
        if (!CanSupportSubField(
                field, (FIT_UINT16) Profile::TRAINING_FILE_MESG_PRODUCT_FIELD_FAVERO_PRODUCT)) {
            return FIT_FALSE;
        }

        return field->IsValueValid(
            0, (FIT_UINT16) Profile::TRAINING_FILE_MESG_PRODUCT_FIELD_FAVERO_PRODUCT);
    }
    ...
    FIT_FAVERO_PRODUCT GetFaveroProduct(void) const {
        return GetFieldUINT16Value(
            2, 0, (FIT_UINT16) Profile::TRAINING_FILE_MESG_PRODUCT_FIELD_FAVERO_PRODUCT);
    }
    ...
    FIT_BOOL IsGarminProductValid() const {
        ...
        if (!CanSupportSubField(
                field, (FIT_UINT16) Profile::TRAINING_FILE_MESG_PRODUCT_FIELD_GARMIN_PRODUCT)) {
            return FIT_FALSE;
        }

        return field->IsValueValid(
            0, (FIT_UINT16) Profile::TRAINING_FILE_MESG_PRODUCT_FIELD_GARMIN_PRODUCT);
    }
    ...
    FIT_GARMIN_PRODUCT GetGarminProduct(void) const {
        return GetFieldUINT16Value(
            2, 0, (FIT_UINT16) Profile::TRAINING_FILE_MESG_PRODUCT_FIELD_GARMIN_PRODUCT);
    }
