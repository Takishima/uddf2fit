...
public:
    ...
    FIT_BOOL IsFaveroProductValid() const {
        ...
        if (!CanSupportSubField(
                field, (FIT_UINT16) Profile::SLAVE_DEVICE_MESG_PRODUCT_FIELD_FAVERO_PRODUCT)) {
            return FIT_FALSE;
        }
    ...
    FIT_FAVERO_PRODUCT GetFaveroProduct(void) const {
        return GetFieldUINT16Value(
            1, 0, (FIT_UINT16) Profile::SLAVE_DEVICE_MESG_PRODUCT_FIELD_FAVERO_PRODUCT);
    }
    ...
    FIT_BOOL IsGarminProductValid() const {
        ...
        if (!CanSupportSubField(
                field, (FIT_UINT16) Profile::SLAVE_DEVICE_MESG_PRODUCT_FIELD_GARMIN_PRODUCT)) {
            return FIT_FALSE;
        }
    ...
    FIT_GARMIN_PRODUCT GetGarminProduct(void) const {
        return GetFieldUINT16Value(
            1, 0, (FIT_UINT16) Profile::SLAVE_DEVICE_MESG_PRODUCT_FIELD_GARMIN_PRODUCT);
    }
