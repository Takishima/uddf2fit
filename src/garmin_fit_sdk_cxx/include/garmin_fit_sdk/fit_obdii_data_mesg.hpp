...
public:
    ...
    // Units: ms
    // Comment: Offset of PID reading [i] from start_timestamp+start_timestamp_ms. Readings may
    ...
    ///////////////////////////////////////////////////////////////////////
    FIT_BYTE GetPid(void) const { return GetFieldBYTEValue(2, 0, FIT_SUBFIELD_INDEX_MAIN_FIELD); }

    ///////////////////////////////////////////////////////////////////////
    // Set pid field
    // Comment: Parameter ID
    ///////////////////////////////////////////////////////////////////////
    void SetPid(FIT_BYTE pid) { SetFieldBYTEValue(2, pid, 0, FIT_SUBFIELD_INDEX_MAIN_FIELD); }
    ...
    // Comment: System time associated with sample expressed in ms, can be used instead of
    // time_offset. There will be a system_time value for each raw_data element. For multibyte pids
    // the system_time is repeated.
    ///////////////////////////////////////////////////////////////////////
    ...
    // Comment: Timestamp of first sample recorded in the message. Used with time_offset to
    // generate time of each sample
    ///////////////////////////////////////////////////////////////////////
