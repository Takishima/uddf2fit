...
public:
    ...
    // Comment: Average of awake_time_score and awakenings_count_score. If valid: 0 (worst) to 100
    ...
    // Comment: Score that evaluates the total time spent awake between sleep. If valid: 0 (worst)
    ...
    // Comment: Score that evaluates the number of awakenings that interrupt sleep. If valid: 0
    ...
    // Comment: Score that evaluates the amount of deep sleep. If valid: 0 (worst) to 100 (best).
    ...
    // Comment: Score that evaluates the quality of sleep based on sleep stages, heart-rate
    // variability and possible awakenings during the night. If valid: 0 (worst) to 100 (best). If
    ...
    // Comment: Score that evaluates the amount of light sleep. If valid: 0 (worst) to 100 (best).
    // If unknown: FIT_UINT8_INVALID.
    ///////////////////////////////////////////////////////////////////////
    ...
    // Comment: Total score that summarizes the overall quality of sleep, combining sleep duration
    // and quality. If valid: 0 (worst) to 100 (best). If unknown: FIT_UINT8_INVALID.
    ///////////////////////////////////////////////////////////////////////
    ...
    // Comment: Score that evaluates stress and recovery during sleep. If valid: 0 (worst) to 100
    // (best). If unknown: FIT_UINT8_INVALID.
    ///////////////////////////////////////////////////////////////////////
    ...
    // Comment: Score that evaluates the amount of REM sleep. If valid: 0 (worst) to 100 (best). If
    // unknown: FIT_UINT8_INVALID.
    ///////////////////////////////////////////////////////////////////////
    ...
    // Comment: Score that evaluates the amount of restlessness during sleep. If valid: 0 (worst)
    // to 100 (best). If unknown: FIT_UINT8_INVALID.
    ///////////////////////////////////////////////////////////////////////
    ...
    // Comment: Score that evaluates the sleep interruptions. If valid: 0 (worst) to 100 (best). If
    // unknown: FIT_UINT8_INVALID.
    ///////////////////////////////////////////////////////////////////////
