...
public:
    ...
    void SetFaveroProduct(FIT_FAVERO_PRODUCT faveroProduct) {
        SetFieldUINT16Value(
            2, faveroProduct, 0, (FIT_UINT16) Profile::FILE_ID_MESG_PRODUCT_FIELD_FAVERO_PRODUCT);
    }
    ...
    void SetGarminProduct(FIT_GARMIN_PRODUCT garminProduct) {
        SetFieldUINT16Value(
            2, garminProduct, 0, (FIT_UINT16) Profile::FILE_ID_MESG_PRODUCT_FIELD_GARMIN_PRODUCT);
    }
    ...
    // Comment: Optional free form string to indicate the devices name or model
    ///////////////////////////////////////////////////////////////////////
    void SetProductName(FIT_WSTRING productName) { SetFieldSTRINGValue(8, productName, 0); }
};
