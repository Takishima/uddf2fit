...
public:
    ...
    FIT_BOOL IsDigitalLayoutValid() const {
        ...
        return field->IsValueValid(
            0, (FIT_UINT16) Profile::WATCHFACE_SETTINGS_MESG_LAYOUT_FIELD_DIGITAL_LAYOUT);
    }
    ...
    FIT_DIGITAL_WATCHFACE_LAYOUT GetDigitalLayout(void) const {
        return GetFieldENUMValue(
            1, 0, (FIT_UINT16) Profile::WATCHFACE_SETTINGS_MESG_LAYOUT_FIELD_DIGITAL_LAYOUT);
    }
    ...
    FIT_BOOL IsAnalogLayoutValid() const {
        ...
        if (!CanSupportSubField(
                field, (FIT_UINT16) Profile::WATCHFACE_SETTINGS_MESG_LAYOUT_FIELD_ANALOG_LAYOUT)) {
            return FIT_FALSE;
        }

        return field->IsValueValid(
            0, (FIT_UINT16) Profile::WATCHFACE_SETTINGS_MESG_LAYOUT_FIELD_ANALOG_LAYOUT);
    }
    ...
    FIT_ANALOG_WATCHFACE_LAYOUT GetAnalogLayout(void) const {
        return GetFieldENUMValue(
            1, 0, (FIT_UINT16) Profile::WATCHFACE_SETTINGS_MESG_LAYOUT_FIELD_ANALOG_LAYOUT);
    }
    ...
    void SetAnalogLayout(FIT_ANALOG_WATCHFACE_LAYOUT analogLayout) {
        SetFieldENUMValue(
            ...
            analogLayout,
            0,
            (FIT_UINT16) Profile::WATCHFACE_SETTINGS_MESG_LAYOUT_FIELD_ANALOG_LAYOUT);
    }
};
