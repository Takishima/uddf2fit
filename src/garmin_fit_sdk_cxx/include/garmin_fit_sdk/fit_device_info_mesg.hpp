...
public:
    ...
    FIT_BOOL IsBleDeviceTypeValid() const {
        ...
        if (!CanSupportSubField(
                field, (FIT_UINT16) Profile::DEVICE_INFO_MESG_DEVICE_TYPE_FIELD_BLE_DEVICE_TYPE)) {
            return FIT_FALSE;
        }

        return field->IsValueValid(
            0, (FIT_UINT16) Profile::DEVICE_INFO_MESG_DEVICE_TYPE_FIELD_BLE_DEVICE_TYPE);
    }
    ...
    FIT_BLE_DEVICE_TYPE GetBleDeviceType(void) const {
        return GetFieldUINT8Value(
            1, 0, (FIT_UINT16) Profile::DEVICE_INFO_MESG_DEVICE_TYPE_FIELD_BLE_DEVICE_TYPE);
    }
    ...
    FIT_BOOL IsAntplusDeviceTypeValid() const {
        ...
        return field->IsValueValid(
            0, (FIT_UINT16) Profile::DEVICE_INFO_MESG_DEVICE_TYPE_FIELD_ANTPLUS_DEVICE_TYPE);
    }
    ...
    FIT_ANTPLUS_DEVICE_TYPE GetAntplusDeviceType(void) const {
        return GetFieldUINT8Value(
            1, 0, (FIT_UINT16) Profile::DEVICE_INFO_MESG_DEVICE_TYPE_FIELD_ANTPLUS_DEVICE_TYPE);
    }
    ...
    FIT_BOOL IsAntDeviceTypeValid() const {
        ...
        if (!CanSupportSubField(
                field, (FIT_UINT16) Profile::DEVICE_INFO_MESG_DEVICE_TYPE_FIELD_ANT_DEVICE_TYPE)) {
            return FIT_FALSE;
        }

        return field->IsValueValid(
            0, (FIT_UINT16) Profile::DEVICE_INFO_MESG_DEVICE_TYPE_FIELD_ANT_DEVICE_TYPE);
    }
    ...
    FIT_UINT8 GetAntDeviceType(void) const {
        return GetFieldUINT8Value(
            1, 0, (FIT_UINT16) Profile::DEVICE_INFO_MESG_DEVICE_TYPE_FIELD_ANT_DEVICE_TYPE);
    }
    ...
    FIT_BOOL IsLocalDeviceTypeValid() const {
        ...
        return field->IsValueValid(
            0, (FIT_UINT16) Profile::DEVICE_INFO_MESG_DEVICE_TYPE_FIELD_LOCAL_DEVICE_TYPE);
    }
    ...
    FIT_LOCAL_DEVICE_TYPE GetLocalDeviceType(void) const {
        return GetFieldUINT8Value(
            1, 0, (FIT_UINT16) Profile::DEVICE_INFO_MESG_DEVICE_TYPE_FIELD_LOCAL_DEVICE_TYPE);
    }
    ...
    FIT_BOOL IsFaveroProductValid() const {
        ...
        if (!CanSupportSubField(
                field, (FIT_UINT16) Profile::DEVICE_INFO_MESG_PRODUCT_FIELD_FAVERO_PRODUCT)) {
            return FIT_FALSE;
        }
    ...
    FIT_FAVERO_PRODUCT GetFaveroProduct(void) const {
        return GetFieldUINT16Value(
            4, 0, (FIT_UINT16) Profile::DEVICE_INFO_MESG_PRODUCT_FIELD_FAVERO_PRODUCT);
    }
    ...
    FIT_BOOL IsGarminProductValid() const {
        ...
        if (!CanSupportSubField(
                field, (FIT_UINT16) Profile::DEVICE_INFO_MESG_PRODUCT_FIELD_GARMIN_PRODUCT)) {
            return FIT_FALSE;
        }
    ...
    FIT_GARMIN_PRODUCT GetGarminProduct(void) const {
        return GetFieldUINT16Value(
            4, 0, (FIT_UINT16) Profile::DEVICE_INFO_MESG_PRODUCT_FIELD_GARMIN_PRODUCT);
    }
    ...
    // Comment: Used to describe the sensor or location
    ///////////////////////////////////////////////////////////////////////
    void SetDescriptor(FIT_WSTRING descriptor) { SetFieldSTRINGValue(19, descriptor, 0); }
    ...
    // Comment: Optional free form string to indicate the devices name or model
    ///////////////////////////////////////////////////////////////////////
    void SetProductName(FIT_WSTRING productName) { SetFieldSTRINGValue(27, productName, 0); }
