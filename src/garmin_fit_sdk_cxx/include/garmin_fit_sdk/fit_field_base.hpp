...
public:
    ...
    FIT_FLOAT32 GetFLOAT32Value(const FIT_UINT8 fieldArrayIndex = 0,
                                ...
                                = FIT_SUBFIELD_INDEX_MAIN_FIELD) const;
...
private:
    ...
    FIT_BOOL GetMemoryValue(const FIT_UINT8 fieldArrayIndex,
                            FIT_UINT8 *buffer,
