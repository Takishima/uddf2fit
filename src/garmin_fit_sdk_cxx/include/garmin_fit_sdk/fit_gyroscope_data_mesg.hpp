...
public:
    ...
    // Units: ms
    // Comment: Each time in the array describes the time at which the gyro sample with the
    // corrosponding index was taken. Limited to 30 samples in each message. The samples may span
    // across seconds. Array size must match the number of samples in gyro_x and gyro_y and gyro_z
    ///////////////////////////////////////////////////////////////////////
