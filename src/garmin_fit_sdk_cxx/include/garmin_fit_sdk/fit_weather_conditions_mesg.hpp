...
public:
    ...
    // Units: C
    // Comment: Heat Index if GCS heatIdx above or equal to 90F or wind chill if GCS windChill
    ...
    // Comment: string corresponding to GCS response location string
    ///////////////////////////////////////////////////////////////////////
    void SetLocation(FIT_WSTRING location) { SetFieldSTRINGValue(8, location, 0); }
